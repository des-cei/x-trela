...
package strela_reg_pkg;
  ...
  parameter logic [BlockAw-1:0] STRELA_MODE_OFFSET = 7'h 4;
  parameter logic [BlockAw-1:0] STRELA_STATUS_OFFSET = 7'h 8;
  parameter logic [BlockAw-1:0] STRELA_PERF_CTR_TOTAL_CYCLES_OFFSET = 7'h c;
  parameter logic [BlockAw-1:0] STRELA_PERF_CTR_EXEC_CYCLES_OFFSET = 7'h 10;
  parameter logic [BlockAw-1:0] STRELA_PERF_CTR_CONF_CYCLES_OFFSET = 7'h 14;
  parameter logic [BlockAw-1:0] STRELA_PERF_CTR_STALL_CYCLES_OFFSET = 7'h 18;
  parameter logic [BlockAw-1:0] STRELA_CONF_ADDR_OFFSET = 7'h 1c;
  ...
  parameter logic [3:0] STRELA_PERMIT [24] = '{
    ...
    4'b 0001, // index[ 1] STRELA_MODE
    4'b 0001, // index[ 2] STRELA_STATUS
    4'b 1111, // index[ 3] STRELA_PERF_CTR_TOTAL_CYCLES
    4'b 1111, // index[ 4] STRELA_PERF_CTR_EXEC_CYCLES
    4'b 1111, // index[ 5] STRELA_PERF_CTR_CONF_CYCLES
    4'b 1111, // index[ 6] STRELA_PERF_CTR_STALL_CYCLES
    4'b 1111, // index[ 7] STRELA_CONF_ADDR
